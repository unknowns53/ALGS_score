...
REGION_PROFILES: dict[str, dict[str, float | int | bool | str]] = {
    "americas": {
        ...
        "placement_fight_correlation": 0.65,
        "placement_win_correlation": 0.60,
        "base_match_noise": 0.70,
    ...
    "emea": {
        ...
        "kill_beta": 0.80,
        "win_beta": 0.80,
        "consistency_beta": 0.55,
        "placement_fight_correlation": 0.60,
        "placement_win_correlation": 0.50,
        "base_match_noise": 0.70,
        "volatility_mean": 0.90,
        "volatility_sigma": 0.20,
        "respawn_model": "negbin",
        "respawn_mean": 6.0,
        "respawn_dispersion": 4.5,
        "neutral_death_rate": 0.01,
        "lost_kill_rate": 0.020,
        "transfer_kill_rate": 0.04,
        "revive_knock_mean": 9.0,
        "mp_pressure_enabled": True,
        "mp_win_penalty": 0.10,
    ...
    "apac_s": {
        ...
        "placement_fight_correlation": 0.50,
        "placement_win_correlation": 0.40,
        "base_match_noise": 0.95,
        "volatility_mean": 1.15,
